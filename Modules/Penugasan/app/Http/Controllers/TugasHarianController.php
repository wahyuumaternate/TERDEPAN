...
class TugasHarianController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // Cek apakah tugas pokok milik user
            ...
            $tugasHarian = TugasHarian::create([
                ...
                'pegawai_id' => $user->id,
                'pemberi_tugas_id' => $user->id, // Self-assigned
                ...
                'is_mandiri' => true,
                'status' => 'pending',
                'status_approval' => 'pending', // Perlu approval atasan
            ]);
            ...
            return response()->json([
                'success' => true,
                'message' => 'Tugas harian berhasil dibuat dan menunggu persetujuan atasan',
                'data' => $tugasHarian
            ]);
        } catch (\Exception $e) {
            DB::rollBack();
