...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Folder Sent untuk arsip email terkirim
    |--------------------------------------------------------------------------
    |
    | Nama folder di mailbox tempat salinan email yang dikirim aplikasi disimpan
    | (lihat App\Listeners\SimpanEmailTerkirimKeSentFolder). Beberapa provider
    | mail pakai "Sent", sebagian "INBOX.Sent" — sesuaikan lewat .env kalau perlu.
    |
    */
