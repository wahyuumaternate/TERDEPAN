            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="mb-0 fw-bold">{{ $pegawai->gelar_depan }} {{ $pegawai->nama }}
                                {{ $pegawai->gelar_belakang }}</h5>
                            <small class="text-muted">{{ $pegawai->nomor_identitas }} • {{ $pegawai->email }}</small>
                        </div>
                    </div>
                    <div class="btn-group">
        ...
        <form id="formPegawai" action="{{ route('master.pegawai.update', $pegawai->id) }}" method="POST"
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="card shadow-sm border-0 mb-4">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="profile-info">
                                <h5 class="fw-bold mb-1">{{ $pegawai->gelar_depan }} {{ $pegawai->nama }}
                                    {{ $pegawai->gelar_belakang }}</h5>
                                <p class="text-muted mb-2">{{ $pegawai->jabatan->nama ?? '-' }}</p>
                                <p class="text-muted small mb-3">{{ $pegawai->bidang->nama ?? '-' }}</p>
                                ...
                                <div class="row text-start">
                                    <div class="col-12 mb-2">
                                        ...
                                        <div class="fw-bold">
                                            @switch($pegawai->status_kepegawaian)
                                                ...
                                                @default
                                                    <span class="badge bg-secondary">{{ $pegawai->status_kepegawaian }}</span>
                                            @endswitch
                                        </div>
                                    </div>
                                    <div class="col-12 mb-2">
                                    ...
                                    @if ($pegawai->last_login_at)
                                        <div class="col-12">
                                            <small class="text-muted">Login Terakhir</small>
                                            <div class="fw-bold small">{{ $pegawai->last_login_at->format('d M Y H:i') }}
                                            </div>
                                        </div>
                                    @endif
                                </div>
                    ...
                    <!-- TTD Digital -->
                    @if ($pegawai->ttdDigital->count() > 0)
                        @php
                            $ttdDigital = $pegawai->ttdDigital->first();
                        @endphp
                        <div class="card shadow-sm border-0">
                            ...
                            <div class="card-body text-center">
                                <img src="{{ asset($ttdDigital->file_path) }}" alt="TTD {{ $pegawai->nama }}"
                                    class="img-fluid border rounded" style="max-height: 100px;">
                                <div class="mt-2">
                                    <small class="text-muted d-block">Berlaku:
                                        {{ date('d M Y', strtotime($ttdDigital->valid_from)) }}</small>
                                    @if ($ttdDigital->valid_until)
                                        <small class="text-muted d-block">Sampai:
                                            {{ date('d M Y', strtotime($ttdDigital->valid_until)) }}</small>
                                    @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="view-mode">
                                        <div class="form-control-plaintext">{{ $pegawai->nomor_identitas }}</div>
                                    </div>
                                    <div class="edit-mode d-none">
                                        <input type="text" class="form-control" name="nomor_identitas"
                                            value="{{ $pegawai->nomor_identitas }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Tipe Identitas</label>
                                    <div class="view-mode">
                                        <div class="form-control-plaintext">{{ $pegawai->tipe_identitas }}</div>
                                    </div>
                                    <div class="edit-mode d-none">
                                        <select class="form-select" name="tipe_identitas" required>
                                            <option value="NIP"
                                                {{ $pegawai->tipe_identitas == 'NIP' ? 'selected' : '' }}>NIP</option>
                                            <option value="NIK"
                                                {{ $pegawai->tipe_identitas == 'NIK' ? 'selected' : '' }}>NIK</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="view-mode">
                                        <div class="form-control-plaintext">{{ $pegawai->gelar_depan ?: '-' }}</div>
                                    </div>
                                    <div class="edit-mode d-none">
                                        <input type="text" class="form-control" name="gelar_depan"
                                            value="{{ $pegawai->gelar_depan }}" placeholder="Dr., Ir., dll">
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="view-mode">
                                        <div class="form-control-plaintext">{{ $pegawai->gelar_belakang ?: '-' }}</div>
                                    </div>
                                    <div class="edit-mode d-none">
                                        <input type="text" class="form-control" name="gelar_belakang"
                                            value="{{ $pegawai->gelar_belakang }}" placeholder="S.T., M.T., dll">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="view-mode">
                                        <div class="form-control-plaintext">{{ $pegawai->no_telepon ?: '-' }}</div>
                                    </div>
                                    <div class="edit-mode d-none">
                                        <input type="text" class="form-control" name="no_telepon"
                                            value="{{ $pegawai->no_telepon }}" placeholder="08xxxxxxxxxx">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="view-mode">
                                        <div class="form-control-plaintext">
                                            {{ $pegawai->jenis_kelamin == 'L' ? 'Laki-laki' : 'Perempuan' }}</div>
                                    </div>
                                    <div class="edit-mode d-none">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <div class="view-mode">
                                        <div class="form-control-plaintext">{{ $pegawai->alamat ?: '-' }}</div>
                                    </div>
                                    <div class="edit-mode d-none">
                                        <textarea class="form-control" name="alamat" rows="3" placeholder="Alamat lengkap">{{ $pegawai->alamat }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="view-mode">
                                        <div class="form-control-plaintext">{{ $pegawai->jabatan->nama ?? '-' }}</div>
                                    </div>
                                    <div class="edit-mode d-none">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="view-mode">
                                        <div class="form-control-plaintext">{{ $pegawai->bidang->nama ?? '-' }}</div>
                                    </div>
                                    <div class="edit-mode d-none">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="view-mode">
                                        <div class="form-control-plaintext">{{ $pegawai->status_kepegawaian }}</div>
                                    </div>
                                    <div class="edit-mode d-none">
                                        <select class="form-select" name="status_kepegawaian" required>
                                            <option value="PNS"
                                                {{ $pegawai->status_kepegawaian == 'PNS' ? 'selected' : '' }}>PNS</option>
                                            <option value="PPPK"
                                                {{ $pegawai->status_kepegawaian == 'PPPK' ? 'selected' : '' }}>PPPK
                                            </option>
                                            <option value="Kontrak"
                                                {{ $pegawai->status_kepegawaian == 'Kontrak' ? 'selected' : '' }}>Kontrak
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="view-mode">
                                        <div class="form-control-plaintext">{{ $pegawai->status_aktif }}</div>
                                    </div>
                                    <div class="edit-mode d-none">
                                        <select class="form-select" name="status_aktif">
                                            <option value="Aktif"
                                                {{ $pegawai->status_aktif == 'Aktif' ? 'selected' : '' }}>Aktif</option>
                                            <option value="Nonaktif"
                                                {{ $pegawai->status_aktif == 'Nonaktif' ? 'selected' : '' }}>Nonaktif
                                            </option>
                                            <option value="Cuti"
                                                {{ $pegawai->status_aktif == 'Cuti' ? 'selected' : '' }}>Cuti</option>
                                            <option value="Pensiun"
                                                {{ $pegawai->status_aktif == 'Pensiun' ? 'selected' : '' }}>Pensiun
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="view-mode">
                                        <div class="form-control-plaintext">{{ $pegawai->pangkat ?: '-' }}</div>
                                    </div>
                                    <div class="edit-mode d-none">
                                        <input type="text" class="form-control" name="pangkat"
                                            value="{{ $pegawai->pangkat }}" placeholder="Penata, Pembina, dll">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Golongan</label>
                                    <div class="view-mode">
                                        <div class="form-control-plaintext">{{ $pegawai->golongan ?: '-' }}</div>
                                    </div>
                                    <div class="edit-mode d-none">
                                        <input type="text" class="form-control" name="golongan"
                                            value="{{ $pegawai->golongan }}" placeholder="III/a, III/b, IV/a, dll">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="view-mode">
                                        <div class="form-control-plaintext">
                                            {{ $pegawai->tanggal_keluar ? date('d M Y', strtotime($pegawai->tanggal_keluar)) : '-' }}
                                        </div>
                                    </div>
                                    <div class="edit-mode d-none">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <div class="view-mode">
                                        <div class="form-control-plaintext">{{ $pegawai->atasanLangsung->nama ?? '-' }}
                                        </div>
                                    </div>
                                    <div class="edit-mode d-none">
                                        <select class="form-select" name="atasan_langsung_id">
                                            <option value="">Pilih Atasan Langsung</option>
                                            @foreach (\App\Models\MasterPegawai::where('id', '!=', $pegawai->id)->get() as $atasan)
    ...
    <script>
        $(document).ready(function() {
            ...
            function resetForm() {
                ...
                // Reset photo preview
                @if ($pegawai->foto_profile_path)
                    $('#profilePhoto').attr('src', '{{ asset($pegawai->foto_profile_path) }}');
                @else
