                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="edit-mode d-none">
                                        <input type="text" class="form-control"
                                            value="{{ $pegawai->jabatan->nama ?? '-' }}" disabled>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="edit-mode d-none">
                                        <input type="text" class="form-control"
                                            value="{{ $pegawai->bidang->nama ?? '-' }}" disabled>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="edit-mode d-none">
                                        <input type="text" class="form-control"
                                            value="{{ $pegawai->status_kepegawaian }}" disabled>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="edit-mode d-none">
                                        <input type="text" class="form-control" value="{{ $pegawai->status_aktif }}"
                                            disabled>
                                        <small class="text-muted">Hubungi administrator untuk mengubah status</small>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="edit-mode d-none">
                                        <input type="text" class="form-control"
                                            value="{{ $pegawai->tanggal_masuk ? date('d M Y', strtotime($pegawai->tanggal_masuk)) : '-' }}"
                                            disabled>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="edit-mode d-none">
                                        <input type="text" class="form-control"
                                            value="{{ $pegawai->atasanLangsung->nama ?? '-' }}" disabled>
